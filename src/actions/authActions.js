...
export const loadUser = () => (dispatch, getState) => {
    ...
    axios.get('http://localhost:8080/website/scrapper/auth/user/me', tokenConfig(getState))
        .then(res => {
            dispatch({
                type: USER_LOADED,
                payload: res.data
...
export const login = ({ email, password }) => dispatch => {
    ...
    axios.post("http://localhost:8080/website/scrapper/auth/login", body, config)
        .then(res => {
