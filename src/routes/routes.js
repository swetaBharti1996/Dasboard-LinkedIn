            ...
            <div>
                <Switch>
                    {props.auth.isAuthenticated && props.auth.user._id ? <Route path="/" render={() => <LayoutCover><Route exact={true} path="/comment" component={Comment} /><Route exact={true} path="/insight" component={Insight} />
                        <Route exact={true} path="/post" component={PostData} /><Route exact={true} path="/profile" component={Profile} /> <Route exact={true} path="/profileDetails" component={ProfileDetails} /></LayoutCover>} /> :
                        <>
